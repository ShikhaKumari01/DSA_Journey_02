...
//     if((checkIdentical(root1->left,root2->left))&&(checkIdentical(root1->right,root2->right))&&(root1->data==root2->data)){
//         return true;
//     }
//     else{
//         return false;
...
//     bool flag=checkIdentical(root1,root2);
//     if(flag){
//         cout<<"Root1 and Root2 are identical"<<endl;
//     }
//     else{
//         cout<<"Root1 and Root2 are not identical"<<endl;
//     }
// }
